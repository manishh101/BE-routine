...
const { exportRoomScheduleToExcel, exportAllRoomSchedulesToExcel } = require('../controllers/excelController');
 ...
 *               format: binary
 */
router.get('/export/all', protect, authorize('admin'), exportAllRoomSchedulesToExcel);
 ...
 *         description: Room not found
 */
router.get('/:id/export', protect, authorize('admin'), exportRoomScheduleToExcel);
