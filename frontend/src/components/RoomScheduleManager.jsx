...
import RoomExcelActions from './RoomExcelActions';
...
const RoomScheduleManager = () => {
  ...
  const calculateStats = () => {
    ...
    if (!roomScheduleData || !roomScheduleData.data || !roomScheduleData.data.routine) {
      return { totalClasses: 0, busyDays: 0, programs: [], utilizationRate: 0 };
    }

    const routine = roomScheduleData.data.routine;
  ...
  const prepareRoomDataForRoutineGrid = () => {
    ...
    if (!roomScheduleData || !roomScheduleData.data) {
