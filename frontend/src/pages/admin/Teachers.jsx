...
import { teachersAPI, routinesAPI, timeSlotsAPI } from '../../services/api';
...
const Teachers = () => {
  ...
  const handleEditSubmit = (values) => {
    if (editingTeacher) {
      ...
      // Handle create new teacher if needed
      message.info('Create new teacher functionality not implemented yet');
    }
  };
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      ...
      confirmLoading={updateTeacherMutation.isLoading}
      width={600}
    >
      <Form
        form={form}
